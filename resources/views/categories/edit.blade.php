...
<div style="background-color: #f3f4f6; padding: 30px 20px;">
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 30px;">
            ...
            <h1 style="font-size: 32px; font-weight: 700; color: #1f2937; margin: 0;">Editar Categoria</h1>
            <p style="color: #6b7280; font-size: 14px; margin-top: 8px;">Atualize os dados da categoria</p>
        </div>
