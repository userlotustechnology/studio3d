...
@section('content')
    ...
    <div class="hero-modern">
        ...
        <div class="container hero-content">
            <span class="hero-badge">📂 Categoria Selecionada</span>
            <h1>{{ $category->name }}</h1>
    ...
    <div class="container main-content">
        ...
        <div class="filter-bar">
            <div class="search-box">
                ...
                <input type="text" placeholder="Buscar nesta categoria..." id="searchInput" onkeyup="filterProducts()">
            </div>
        ...
        @if($categories->count() > 0)
            <div class="categories-modern">
                <a href="{{ route('shop.index') }}" class="category-pill">
                    <i class="fas fa-fire"></i> Todos
                </a>
                @foreach($categories as $cat)
                    <a href="{{ route('shop.category', $cat->id) }}" class="category-pill {{ $cat->id === $category->id ? 'active' : '' }}">
                        {{ $cat->name }}
                    </a>
                @endforeach
            </div>
        ...
        @else
            <div class="empty-state-modern">
                ...
                <a href="{{ route('shop.index') }}" class="btn-primary-modern">
                    <i class="fas fa-home"></i> Ver Todos os Produtos
                </a>
            </div>
        @endif
