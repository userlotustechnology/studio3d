...
@section('title', 'Pedidos Pendentes - Admin')
...
<div style="background-color: #f3f4f6; padding: 30px 20px;">
    <div style="max-width: 1400px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 30px;">
            <h1 style="font-size: 32px; font-weight: 700; color: #1f2937; margin: 0;">Pedidos Pendentes</h1>
            <p style="color: #6b7280; font-size: 14px; margin-top: 8px;">Pedidos aguardando processamento</p>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="padding: 40px; text-align: center; color: #6b7280;">
                            <i class="fas fa-check-circle" style="font-size: 48px; margin-bottom: 16px; display: block; opacity: 0.5;"></i>
                            <p style="margin: 0;">Nenhum pedido pendente!</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
